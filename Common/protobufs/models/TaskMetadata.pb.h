...
class TaskMetadata : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_upload_time(::std::string* upload_time);
...
inline void TaskMetadata::set_allocated_filename(::std::string* filename) {
  if (filename_ != &::google::protobuf::internal::kEmptyString) {
    delete filename_;
  }
  if (filename) {
...
inline void TaskMetadata::set_allocated_content_type(::std::string* content_type) {
  if (content_type_ != &::google::protobuf::internal::kEmptyString) {
...
inline void TaskMetadata::set_allocated_upload_time(::std::string* upload_time) {
  if (upload_time_ != &::google::protobuf::internal::kEmptyString) {
    delete upload_time_;
  }
  if (upload_time) {
    set_has_upload_time();
    upload_time_ = upload_time;
  } else {
    clear_has_upload_time();
    upload_time_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
