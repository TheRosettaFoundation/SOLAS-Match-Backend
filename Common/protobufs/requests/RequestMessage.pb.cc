...
static void InitDefaultsscc_info_RequestMessage_RequestMessage_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::SolasMatch::Common::Protobufs::Requests::_RequestMessage_default_instance_;
    new (ptr) ::SolasMatch::Common::Protobufs::Requests::RequestMessage();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::SolasMatch::Common::Protobufs::Requests::RequestMessage::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RequestMessage_RequestMessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RequestMessage_RequestMessage_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_RequestMessage_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_RequestMessage_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_RequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::SolasMatch::Common::Protobufs::Requests::RequestMessage, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::SolasMatch::Common::Protobufs::Requests::RequestMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::SolasMatch::Common::Protobufs::Requests::RequestMessage, class_name_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::SolasMatch::Common::Protobufs::Requests::RequestMessage)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::SolasMatch::Common::Protobufs::Requests::_RequestMessage_default_instance_),
};
...
const char descriptor_table_protodef_RequestMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_RequestMessage_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_RequestMessage_2eproto_sccs[1] = {
  &scc_info_RequestMessage_RequestMessage_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RequestMessage_2eproto = {
  false, false, descriptor_table_protodef_RequestMessage_2eproto, "RequestMessage.proto", 98,
  &descriptor_table_RequestMessage_2eproto_once, descriptor_table_RequestMessage_2eproto_sccs, descriptor_table_RequestMessage_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_RequestMessage_2eproto::offsets,
  file_level_metadata_RequestMessage_2eproto, 1, file_level_enum_descriptors_RequestMessage_2eproto, file_level_service_descriptors_RequestMessage_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_RequestMessage_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_RequestMessage_2eproto)), true);
namespace SolasMatch {
namespace Common {
namespace Protobufs {
namespace Requests {
...
RequestMessage::RequestMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:SolasMatch.Common.Protobufs.Requests.RequestMessage)
}
...
void RequestMessage::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RequestMessage_RequestMessage_2eproto.base);
  class_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "SolasMatch.Common.Protobufs.Requests.RequestMessage.class_name");
          #endif  // !NDEBUG
          CHK_(ptr);
...
template<> PROTOBUF_NOINLINE ::SolasMatch::Common::Protobufs::Requests::RequestMessage* Arena::CreateMaybeMessage< ::SolasMatch::Common::Protobufs::Requests::RequestMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::SolasMatch::Common::Protobufs::Requests::RequestMessage >(arena);
}
