...
class UserFeedback : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Emails.UserFeedback) */ {
 public:
  UserFeedback();
  ...
  inline UserFeedback* New() const { return New(NULL); }

  UserFeedback* New(::google::protobuf::Arena* arena) const;
