...
qDebug() << "display_name: " << MySQLHandler::getStringFromQuery(fieldMap.value("display_name"), q) << ", length(): " << MySQLHandler::getStringFromQuery(fieldMap.value("display_name"), q).length();
