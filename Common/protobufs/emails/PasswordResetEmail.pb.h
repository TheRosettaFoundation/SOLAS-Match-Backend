...
class PasswordResetEmail : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Emails.PasswordResetEmail) */ {
 public:
  PasswordResetEmail();
  ...
  inline PasswordResetEmail* New() const { return New(NULL); }

  PasswordResetEmail* New(::google::protobuf::Arena* arena) const;
