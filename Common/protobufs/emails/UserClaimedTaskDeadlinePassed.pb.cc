...
const ::google::protobuf::Descriptor* UserClaimedTaskDeadlinePassed_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  UserClaimedTaskDeadlinePassed_reflection_ = NULL;
...
void protobuf_AssignDesc_UserClaimedTaskDeadlinePassed_2eproto() {
  ...
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "UserClaimedTaskDeadlinePassed.proto");
  GOOGLE_CHECK(file != NULL);
  UserClaimedTaskDeadlinePassed_descriptor_ = file->message_type(0);
  static const int UserClaimedTaskDeadlinePassed_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UserClaimedTaskDeadlinePassed, email_type_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UserClaimedTaskDeadlinePassed, task_id_),
...
void protobuf_ShutdownFile_UserClaimedTaskDeadlinePassed_2eproto() {
  delete UserClaimedTaskDeadlinePassed::default_instance_;
...
void protobuf_AddDesc_UserClaimedTaskDeadlinePassed_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "k_id\030\002 \002(\005\022\025\n\rtranslator_id\030\003 \002(\005", 273);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "UserClaimedTaskDeadlinePassed.proto", &protobuf_RegisterTypes);
  UserClaimedTaskDeadlinePassed::default_instance_ = new UserClaimedTaskDeadlinePassed();
  UserClaimedTaskDeadlinePassed::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_UserClaimedTaskDeadlinePassed_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_UserClaimedTaskDeadlinePassed_2eproto {
  StaticDescriptorInitializer_UserClaimedTaskDeadlinePassed_2eproto() {
    protobuf_AddDesc_UserClaimedTaskDeadlinePassed_2eproto();
  }
} static_descriptor_initializer_UserClaimedTaskDeadlinePassed_2eproto_;
...
const ::google::protobuf::Descriptor* UserClaimedTaskDeadlinePassed::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return UserClaimedTaskDeadlinePassed_descriptor_;
}

const UserClaimedTaskDeadlinePassed& UserClaimedTaskDeadlinePassed::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_UserClaimedTaskDeadlinePassed_2eproto();
...
::google::protobuf::Metadata UserClaimedTaskDeadlinePassed::GetMetadata() const {
  ...
  metadata.descriptor = UserClaimedTaskDeadlinePassed_descriptor_;
  metadata.reflection = UserClaimedTaskDeadlinePassed_reflection_;
  return metadata;
}
