...
class UserReferenceEmail : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Emails.UserReferenceEmail) */ {
 public:
  UserReferenceEmail();
  ...
  inline UserReferenceEmail* New() const { return New(NULL); }

  UserReferenceEmail* New(::google::protobuf::Arena* arena) const;
