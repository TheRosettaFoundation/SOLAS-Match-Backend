...
class BannedLogin : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:BannedLogin)
 private:
...
inline ::EmailMessage_Type BannedLogin::email_type() const {
  return static_cast< ::EmailMessage_Type >(email_type_);
}
inline void BannedLogin::set_email_type(::EmailMessage_Type value) {
