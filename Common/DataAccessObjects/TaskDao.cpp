...
std::string TaskDao::get_matecat_url(QSharedPointer<MySQLHandler> db, QSharedPointer<Task> task, QMap<QString, QVariant> memsource_task)
{
    ...
    if (!memsource_task.isEmpty()) {
        ...
        matecat_url = QString("https://twbplatform.org/simplesaml/saml2/idp/SSOService.php?spentityid=https://cloud.memsource.com/web/saml2Login/metadata/127330&RelayState=https://cloud.memsource.com/web/job/") + memsource_task["memsource_task_uid"].toString() + "/translate";
