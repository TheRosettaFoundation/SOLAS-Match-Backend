...
void protobuf_AddDesc_OrgCreatedNotificationRequest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n#OrgCreatedNotificationRequest.proto\"b\n"
    "\035OrgCreatedNotificationRequest\0221\n\nclass_"
    "name\030\001 \002(\t:\035OrgCreatedNotificationReques"
    "t\022\016\n\006org_id\030\002 \002(\005", 137);
...
const ::std::string OrgCreatedNotificationRequest::_default_class_name_("OrgCreatedNotificationRequest");
#ifndef _MSC_VER
...
const OrgCreatedNotificationRequest& OrgCreatedNotificationRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_OrgCreatedNotificationRequest_2eproto();  return *default_instance_;
}
