...
class ArchivedProject : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_impact(::std::string* impact);
  ...
  // optional .Locale sourceLocale = 10;
  ...
  inline void set_allocated_filetoken(::std::string* filetoken);
  ...
  inline void set_allocated_mimetype(::std::string* mimetype);
...
inline const ::Locale& ArchivedProject::sourcelocale() const {
  return sourcelocale_ != NULL ? *sourcelocale_ : *default_instance_->sourcelocale_;
}
inline ::Locale* ArchivedProject::mutable_sourcelocale() {
  set_has_sourcelocale();
  if (sourcelocale_ == NULL) sourcelocale_ = new ::Locale;
  return sourcelocale_;
}
inline ::Locale* ArchivedProject::release_sourcelocale() {
  clear_has_sourcelocale();
  ::Locale* temp = sourcelocale_;
  sourcelocale_ = NULL;
  return temp;
}
inline void ArchivedProject::set_allocated_sourcelocale(::Locale* sourcelocale) {
