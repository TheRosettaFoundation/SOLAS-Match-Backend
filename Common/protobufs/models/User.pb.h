...
class User : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_created_time(::std::string* created_time);
  ...
  inline void set_allocated_nativelocale(::Locale* nativelocale);
...
inline void User::set_allocated_nativelocale(::Locale* nativelocale) {
