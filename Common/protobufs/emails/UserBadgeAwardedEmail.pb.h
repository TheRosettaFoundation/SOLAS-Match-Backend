...
class UserBadgeAwardedEmail : public ::google::protobuf::Message {
 public:
  ...
  UserBadgeAwardedEmail* New() const;
  ...
  // @@protoc_insertion_point(class_scope:UserBadgeAwardedEmail)
 private:
...
inline ::EmailMessage_Type UserBadgeAwardedEmail::email_type() const {
  return static_cast< ::EmailMessage_Type >(email_type_);
}
inline void UserBadgeAwardedEmail::set_email_type(::EmailMessage_Type value) {
