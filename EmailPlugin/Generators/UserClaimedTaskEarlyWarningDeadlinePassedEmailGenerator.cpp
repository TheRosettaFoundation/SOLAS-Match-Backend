#include "UserClaimedTaskEarlyWarningDeadlinePassedEmailGenerator.h"
...
void UserClaimedTaskEarlyWarningDeadlinePassedEmailGenerator::run()
{
    ...
    if(error.compare("") == 0) {
        ...
        QString template_location = QString(TEMPLATE_DIRECTORY) + "emails/user-claimed-task-early-warning-deadline-passed.tpl";
