...
void protobuf_AddDesc_TaskRevokedNotification_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\002(\005\022\023\n\013claimant_id\030\003 \002(\005", 184);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "TaskRevokedNotification.proto", &protobuf_RegisterTypes);
  TaskRevokedNotification::_default_class_name_ =
      new ::std::string("TaskRevokedNotification", 23);
...
const TaskRevokedNotification& TaskRevokedNotification::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_TaskRevokedNotification_2eproto();
