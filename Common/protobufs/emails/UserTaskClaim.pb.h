...
class UserTaskClaim : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Emails.UserTaskClaim) */ {
 public:
  UserTaskClaim();
  ...
  inline UserTaskClaim* New() const { return New(NULL); }

  UserTaskClaim* New(::google::protobuf::Arena* arena) const;
