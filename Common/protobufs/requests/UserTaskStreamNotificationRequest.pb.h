...
class UserTaskStreamNotificationRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Requests.UserTaskStreamNotificationRequest) */ {
 public:
  ...
  inline UserTaskStreamNotificationRequest* New() const { return New(NULL); }

  UserTaskStreamNotificationRequest* New(::google::protobuf::Arena* arena) const;
