...
#ifndef PROTOBUF_RequestMessage_2eproto__INCLUDED
#define PROTOBUF_RequestMessage_2eproto__INCLUDED
...
class RequestMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SolasMatch.Common.Protobufs.Requests.RequestMessage) */ {
 public:
  RequestMessage();
 ...
 private:
  ...
  friend void  protobuf_AddDesc_RequestMessage_2eproto();
  friend void protobuf_AssignDesc_RequestMessage_2eproto();
  friend void protobuf_ShutdownFile_RequestMessage_2eproto();
...
#endif  // PROTOBUF_RequestMessage_2eproto__INCLUDED
