...
<p>
    ...
    task for "{{TASK_TITLE}}" from {{SOURCE_LANGUAGE}} into {{TARGET_LANGUAGE}}. 
    To download the the latest version of the file click <a href="{{TASK_REVIEW}}">here</a>. 
    On this page you can provide a rating for the volunteer's work and download
    the latest output file. You can visit your <a href="{{DASHBOARD_URL}}">client dashboard</a> to check 
    the status of any tasks uploaded by your organisation(s). You will find the project for this task 
    under the {{ORG_NAME}} title.
</p>
