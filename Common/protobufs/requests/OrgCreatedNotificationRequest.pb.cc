...
void protobuf_AssignDesc_OrgCreatedNotificationRequest_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_OrgCreatedNotificationRequest_2eproto() {
  ...
  OrgCreatedNotificationRequest_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(OrgCreatedNotificationRequest, _internal_metadata_),
      -1);
}
...
void protobuf_AddDesc_OrgCreatedNotificationRequest_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
OrgCreatedNotificationRequest::OrgCreatedNotificationRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
}
...
OrgCreatedNotificationRequest* OrgCreatedNotificationRequest::New(::google::protobuf::Arena* arena) const {
  OrgCreatedNotificationRequest* n = new OrgCreatedNotificationRequest;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
  return false;
#undef DO_
}
...
void OrgCreatedNotificationRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
  // required string class_name = 1 [default = "OrgCreatedNotificationRequest"];
  if (has_class_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->class_name().data(), this->class_name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
}

::google::protobuf::uint8* OrgCreatedNotificationRequest::InternalSerializeWithCachedSizesToArray(
...
int OrgCreatedNotificationRequest::RequiredFieldsByteSizeFallback() const {
...
// @@protoc_insertion_point(generalized_merge_from_start:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest)
  ...
  const OrgCreatedNotificationRequest* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const OrgCreatedNotificationRequest>(
          &from);
  if (source == NULL) {
...
// required string class_name = 1 [default = "OrgCreatedNotificationRequest"];
bool OrgCreatedNotificationRequest::has_class_name() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void OrgCreatedNotificationRequest::set_has_class_name() {
  _has_bits_[0] |= 0x00000001u;
}
void OrgCreatedNotificationRequest::clear_has_class_name() {
  _has_bits_[0] &= ~0x00000001u;
}
void OrgCreatedNotificationRequest::clear_class_name() {
  class_name_.ClearToDefaultNoArena(_default_class_name_);
  clear_has_class_name();
}
 const ::std::string& OrgCreatedNotificationRequest::class_name() const {
 ...
 void OrgCreatedNotificationRequest::set_class_name(const ::std::string& value) {
  set_has_class_name();
 ...
 void OrgCreatedNotificationRequest::set_class_name(const char* value) {
  set_has_class_name();
 ...
 void OrgCreatedNotificationRequest::set_class_name(const char* value, size_t size) {
  set_has_class_name();
 ...
 ::std::string* OrgCreatedNotificationRequest::mutable_class_name() {
  set_has_class_name();
 ...
 ::std::string* OrgCreatedNotificationRequest::release_class_name() {
 ...
 void OrgCreatedNotificationRequest::set_allocated_class_name(::std::string* class_name) {
  if (class_name != NULL) {
    set_has_class_name();
  } else {
    clear_has_class_name();
...
// required int32 org_id = 2;
bool OrgCreatedNotificationRequest::has_org_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void OrgCreatedNotificationRequest::set_has_org_id() {
  _has_bits_[0] |= 0x00000002u;
}
void OrgCreatedNotificationRequest::clear_has_org_id() {
  _has_bits_[0] &= ~0x00000002u;
}
void OrgCreatedNotificationRequest::clear_org_id() {
  org_id_ = 0;
  clear_has_org_id();
}
 ::google::protobuf::int32 OrgCreatedNotificationRequest::org_id() const {
  // @@protoc_insertion_point(field_get:SolasMatch.Common.Protobufs.Requests.OrgCreatedNotificationRequest.org_id)
  return org_id_;
}
 void OrgCreatedNotificationRequest::set_org_id(::google::protobuf::int32 value) {
  set_has_org_id();
  org_id_ = value;
